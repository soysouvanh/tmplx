...
mod examples {
    ...
    fn example_01_modular_architecture() {
        ...
        let mut output = String::with_capacity(generated::TMPLX_STATIC_SIZE_RENDER_PAGE + 128);
        assert_eq!(
            output.capacity(),
            generated::TMPLX_STATIC_SIZE_RENDER_PAGE + 128
        );
    ...
    fn example_02_local_vars_and_loops() {
        ...
        let mut output = String::with_capacity(generated::TMPLX_STATIC_SIZE_RENDER_VARIABLES + 256);
        ...
        render_variables!(&mut output, &data);
